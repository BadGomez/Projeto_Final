...
public class DisplayPacientes extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public Loader<Cursor> onCreateLoader(int id, @Nullable Bundle args) {
        return new CursorLoader(this, ContentProviderFinal.ENDERECO_PACIENTES, BdTabelaPacientes.TODOS_CAMPOS_PACIENTES, null, null, BdTabelaPacientes.NOME_PACIENTE);
    }
    ...
    public void onLoadFinished(@NonNull Loader<Cursor> loader, Cursor data) {
        adaptadorPacientes.setCursor(data);
    }
